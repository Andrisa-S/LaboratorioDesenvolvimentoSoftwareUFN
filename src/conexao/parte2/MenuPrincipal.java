...
public class MenuPrincipal extends javax.swing.JFrame {
    ...
    public MenuPrincipal() {
        ...
        RelProduto relProd = new RelProduto();
        RelCategoria relCat = new RelCategoria();
        
        jTabbedPane.addTab("Produto", crudProd);
        jTabbedPane.addTab("Categoria", crudCat);
        jTabbedPane.addTab("Relatório Produto", relProd);
        jTabbedPane.addTab("Relatório Categoria", relCat);
    }
